// Admin Dashboard Status Constants
...
export const JOB_STATUS_OPTIONS = [
  ...
  { value: JOB_STATUSES.REQUESTED, label: JOB_STATUS_LABELS[JOB_STATUSES.REQUESTED] },
  { value: JOB_STATUSES.FINDING_INTERPRETER, label: JOB_STATUS_LABELS[JOB_STATUSES.FINDING_INTERPRETER] },
  { value: JOB_STATUSES.ASSIGNED, label: JOB_STATUS_LABELS[JOB_STATUSES.ASSIGNED] },
  { value: JOB_STATUSES.REMINDERS_SENT, label: JOB_STATUS_LABELS[JOB_STATUSES.REMINDERS_SENT] },
  ...
  { value: JOB_STATUSES.COMPLETION_REPORT, label: JOB_STATUS_LABELS[JOB_STATUSES.COMPLETION_REPORT] },
  { value: JOB_STATUSES.BILLED, label: JOB_STATUS_LABELS[JOB_STATUSES.BILLED] },
  { value: JOB_STATUSES.CLOSED, label: JOB_STATUS_LABELS[JOB_STATUSES.CLOSED] },
  { value: JOB_STATUSES.INTERPRETER_PAID, label: JOB_STATUS_LABELS[JOB_STATUSES.INTERPRETER_PAID] },
  ...
  { value: JOB_STATUSES.REJECTED, label: JOB_STATUS_LABELS[JOB_STATUSES.REJECTED] }
];
...
export const BILLABLE_JOB_STATUSES = [
  JOB_STATUSES.COMPLETED,
  JOB_STATUSES.COMPLETION_REPORT,
  JOB_STATUSES.BILLED,
  JOB_STATUSES.CLOSED,
...
export const canAdminApproveJob = (status) => {
  return status === JOB_STATUSES.REQUESTED;
};

export const canAdminRejectJob = (status) => {
  return status === JOB_STATUSES.REQUESTED;
};

export const canAdminSendToInterpreters = (status) => {
  return status === JOB_STATUSES.REQUESTED;
};

export const canAdminSendReminders = (status) => {
  return [JOB_STATUSES.ASSIGNED, JOB_STATUSES.REMINDERS_SENT].includes(status);
};

export const canAdminMarkAsBilled = (status) => {
  return [JOB_STATUSES.COMPLETION_REPORT, JOB_STATUSES.COMPLETED].includes(status);
};

export const canAdminMarkAsClosed = (status) => {
  return status === JOB_STATUSES.BILLED;
};

export const canAdminMarkInterpreterPaid = (status) => {
  return [JOB_STATUSES.BILLED, JOB_STATUSES.CLOSED].includes(status);
};

export const canAdminCancelJob = (status) => {
  return [
    JOB_STATUSES.REQUESTED,
    JOB_STATUSES.FINDING_INTERPRETER,
    JOB_STATUSES.ASSIGNED,
