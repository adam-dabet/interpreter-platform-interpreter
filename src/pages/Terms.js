        ...
        <div className="space-y-6 text-gray-700">
          ...
          <section>
            ...
            <div className="space-y-3">
              ...
              <div className="mt-4">
                <p className="font-semibold mb-2">Portal Use & Invoicing:</p>
                <p>
                  When Contractor uses the Company portal, submission of a separate invoice is not required.
                  Payout is calculated automatically from the Completion Report. If Contractor does not use the
                  portal, Contractor shall email a personal invoice to ap@theintegritycompanyinc.com including
                  job number, date of service, start and end times, total hours worked, and approved mileage.
                </p>
              </div>
          ...
          <section>
            <h2 className="text-xl font-bold text-gray-900 mb-3">13. Court Interpreter Assignments</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-bold text-gray-900 mb-3">14. Authorization for Extended Court Assignments</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-bold text-gray-900 mb-3">15. Interpreter Availability During Proceedings</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-bold text-gray-900 mb-3">16. Claimant No-Show Procedure</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-bold text-gray-900 mb-3">17. Technology & Portal Security</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-bold text-gray-900 mb-3">18. Interpreter Network Protection</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-bold text-gray-900 mb-3">19. Extended Client Non-Solicitation Period</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-bold text-gray-900 mb-3">20. Professional Conduct and Background Checks</h2>
            <p>
