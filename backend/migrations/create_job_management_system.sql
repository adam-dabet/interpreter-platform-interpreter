...
CREATE INDEX idx_jobs_languages ON jobs(source_language_id, target_language_id);
CREATE INDEX idx_jobs_service_type ON jobs(service_type_id);
CREATE INDEX idx_jobs_assigned_interpreter ON jobs(assigned_interpreter_id);
CREATE INDEX idx_jobs_created_by ON jobs(created_by);

CREATE INDEX idx_job_assignments_job_id ON job_assignments(job_id);
CREATE INDEX idx_job_assignments_interpreter_id ON job_assignments(interpreter_id);
...
CREATE INDEX idx_job_notifications_interpreter_id ON job_notifications(interpreter_id);
CREATE INDEX idx_job_notifications_sent_at ON job_notifications(sent_at);
