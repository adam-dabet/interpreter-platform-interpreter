...
const jobAPI = {
  ...
  indicateAvailability: (jobId, mileage_requested = 0, team_member_id = null, mileage_rate = null) =>
    api.post(`/jobs/${jobId}/indicate-available`, { mileage_requested, team_member_id, mileage_rate }),
